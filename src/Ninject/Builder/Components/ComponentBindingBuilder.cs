// -------------------------------------------------------------------------------------------------
// <copyright file="ComponentBindingBuilder.cs" company="Ninject Project Contributors">
...
namespace Ninject.Builder.Components
{
    ...
    internal abstract class ComponentBindingBuilder
    {
        protected ComponentBindingBuilder(Type service)
        {
