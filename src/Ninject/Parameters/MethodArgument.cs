// -------------------------------------------------------------------------------------------------
// <copyright file="MethodArgument.cs" company="Ninject Project Contributors">
...
{
    public class MethodArgument : IMethodArgument, IEquatable<MethodArgument>
    {
        /// <summary>
        ...
        public MethodArgument(string name, object value, bool shouldInherit)
        ...
        public MethodArgument(string name, Func<IContext, object> valueCallback)
        ...
        public MethodArgument(string name, Func<IContext, object> valueCallback, bool shouldInherit)
        {
        ...
        /// <param name="name">The name of the argument to override.</param>
        /// <param name="valueCallback">The callback to invoke to get the value that should be injected.</param>
        public MethodArgument(string name, Func<IContext, ITarget<ParameterInfo>, object> valueCallback)
            : this(name, valueCallback, false)
        {
        }
        ...
        /// <param name="valueCallback">The callback to invoke to get the value that should be injected.</param>
        /// <param name="shouldInherit">if set to <see langword="true"/> [should inherit].</param>
        public MethodArgument(string name, Func<IContext, ITarget<ParameterInfo>, object> valueCallback, bool shouldInherit)
        {
            Ensure.ArgumentNotNullOrEmpty(name, nameof(name));
            Ensure.ArgumentNotNull(valueCallback, nameof(valueCallback));
        ...
        {
            return obj is MethodArgument argument ? this.Equals(argument) : base.Equals(obj);
        }
