// -------------------------------------------------------------------------------------------------
// <copyright file="IConstructorInjectionDirective.cs" company="Ninject Project Contributors">
...
namespace Ninject.Planning.Directives
{
    ...
    public interface IConstructorInjectionDirective : IDirective
    {
        ...
        /// </summary>
        ConstructorInjector Injector { get; }

        /// <summary>
        /// Gets the targets for the directive.
        /// </summary>
        ITarget<ParameterInfo>[] Targets { get; }
    }
}