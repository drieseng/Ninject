...
namespace Ninject.Syntax
{
    ...
    public interface INewBindingToSyntax<T1> : IFluentSyntax
    {
        /// <summary>
        ...
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInNamedSyntax<T1> ToMethod(Func<IContext, T1> method);
        ...
        /// <param name="method">The method.</param>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInNamedSyntax<TImplementation> ToMethod<TImplementation>(
