namespace Ninject.Syntax
{
    ...
    public interface INewBindingWhenInSyntax<T> : IFluentSyntax
    {
        #region In
        ...
        INewBindingWhenOrOnActivationSyntax<T> InSingletonScope();
        ...
        /// </summary>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenSyntax<T> InTransientScope();

        /// <summary>
        /// Indicates that instances activated via the binding should be re-used within the same thread.
        /// </summary>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenOrOnActivationSyntax<T> InThreadScope();
        ...
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenOrOnActivationSyntax<T> InScope(Func<IContext, object> scope);
        ...
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> When(Func<IRequest, bool> condition);
        ...
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenInjectedInto<TParent>();
        ...
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenInjectedInto(Type parent);
        ...
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenInjectedInto(params Type[] parents);
        ...
        /// <typeparam name="TParent">The type.</typeparam>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenInjectedExactlyInto<TParent>();
        ...
        /// <param name="parent">The type.</param>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenInjectedExactlyInto(Type parent);
        ...
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenInjectedExactlyInto(params Type[] parents);
        ...
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenClassHas<TAttribute>()
        ...
        /// <typeparam name="TAttribute">The type of attribute.</typeparam>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenMemberHas<TAttribute>()
            where TAttribute : Attribute;
        ...
        /// <typeparam name="TAttribute">The type of attribute.</typeparam>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenTargetHas<TAttribute>()
            where TAttribute : Attribute;
        ...
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenClassHas(Type attributeType);
        ...
        /// <param name="attributeType">The type of attribute.</param>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenMemberHas(Type attributeType);
        ...
        /// <param name="attributeType">The type of attribute.</param>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenTargetHas(Type attributeType);
        ...
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenParentNamed(string name);
        ...
        /// <param name="name">The name to expect.</param>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenAnyAncestorNamed(string name);
        ...
        /// <param name="name">The name to expect.</param>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenNoAncestorNamed(string name);
        ...
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenAnyAncestorMatches(Predicate<IContext> predicate);
        ...
        /// <param name="predicate">The predicate to match.</param>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenInSyntax<T> WhenNoAncestorMatches(Predicate<IContext> predicate);
