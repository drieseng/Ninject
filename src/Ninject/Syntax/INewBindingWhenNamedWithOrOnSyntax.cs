namespace Ninject.Syntax
{
    ...
    public interface INewBindingWhenNamedWithOrOnSyntax<T> : IFluentSyntax
    {
        ...
        /// <param name="callback">The callback to invoke to get the value for the argument.</param>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenNamedWithOrOnSyntax<T> WithConstructorArgument(string name, Func<IContext, ITarget<IConstructorArgument>, object> callback);
        ...
        /// <param name="callback">The callback to invoke to get the value for the argument.</param>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenNamedWithOrOnSyntax<T> WithConstructorArgument<TValue>(Func<IContext, ITarget<IConstructorArgument>, TValue> callback);
        ...
        /// <param name="callback">The callback to invoke to get the value for the argument.</param>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenNamedWithOrOnSyntax<T> WithConstructorArgument(Type type, Func<IContext, ITarget<IConstructorArgument>, object> callback);
        ...
        /// <param name="callback">The callback to invoke to get the value for the property.</param>
        /// <returns>The fluent syntax.</returns>
        INewBindingWhenNamedWithOrOnSyntax<T> WithPropertyValue(string name, Func<IContext, ITarget<IPropertyValue>, object> callback);
        ...
        INewBindingWhenNamedWithOrOnSyntax<T> WhenAnyAnchestorNamed(string name);
